...
/// Simple file tree node component
#[component]
pub fn SimpleFileTreeNode(
    entry: FileEntry,
    depth: u32,
    is_root: bool,
) -> Element {
            ...
            div {
                ...
                ondoubleclick: move |_| {
                    if is_directory {
                        ...
                        file_tree_state.write().expanded_directories.insert(path.clone(), !current_expanded);
                    }
                },
